    ...
    function(module, exports, __webpack_require__) {
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = 'https://raw.githubusercontent.com/xiryg/blog_picture/main/min_photos/' + data.link[i];
            var src = 'https://raw.githubusercontent.com/xiryg/blog_picture/main/photos/' + data.link[i];
      
            var type = data.type[i];
            var target = src + (type === 'video' ? '.mp4' : '.jpg');
      
            // 利用div元素框住图片，并设置margin样式来添加间隔
          ...
          ulTmpl = ulTmpl + '<section class="archives test_album"><h1 class="year">' + data.year + '年<em>' + data.month + '月</em></h1>\
      ...
      function loadData(success) {
        if (!searchData) {
          ...
          xhr.open('GET', '../lib/test_album/data.json?t=' + +new Date(), true);
